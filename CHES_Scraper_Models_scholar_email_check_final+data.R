## CHES Scraper Models Final + Data Collection
## Scholar Email Check
...
#belgium
#belgium <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_2019_checked_Marcos/belgium.xlsx"
#dat <- read_excel(belgium, sheet = 1)

#cyprus
#cyprus <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_2019_checked_Marcos/cyprus.xlsx"
#dat <- read_excel(cyprus, sheet = 1)

#denmark
#denmark <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_2019_checked_Marcos/denmark.xlsx"
#dat <- read_excel(denmark, sheet = 1)

#finland
#finland <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_2019_checked_Marcos/finland.xlsx"
#dat <- read_excel(finland, sheet = 1)

#france (joined with france2)
#france <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_2019_checked_Marcos/france.xlsx"
#dat <- read_excel(france, sheet = 1)

#germany
#germany <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_2019_checked_Marcos/germany.xlsx"
#dat <- read_excel(germany, sheet = 1)

#greece
#greece <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_2019_checked_Marcos/greece.xlsx"
#dat <- read_excel(greece, sheet = 1)

#iceland
#iceland <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_2019_checked_Marcos/iceland.xlsx"
#dat <- read_excel(iceland, sheet = 1)

#ireland
#ireland <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_2019_checked_Marcos/ireland.xlsx"
#dat <- read_excel(ireland, sheet = 1)

#italy
#italy <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_2019_checked_Marcos/italy.xlsx"
#dat <- read_excel(italy, sheet = 1)

#austria_ukr
#austria_ukr <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_Ukraine_checked_Marcos/Austria_Qualtrics_Ready.xlsx"
#dat <- read_excel(austria_ukr, sheet = 1)

#belgium_ukr
#belgium_ukr <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_Ukraine_checked_Marcos/Belgium_Qualtrics_Ready.xlsx"
#dat <- read_excel(belgium_ukr, sheet = 1)

#denmark_ukr
#denmark_ukr <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_Ukraine_checked_Marcos/Denmark_Qualtrics_Ready.xlsx"
#dat <- read_excel(denmark_ukr, sheet = 1)

#finland_ukr
#finland_ukr <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_Ukraine_checked_Marcos/Finland_Qualtrics_Ready.xlsx"
#dat <- read_excel(finland_ukr, sheet = 1)

#france_ukr
#france_ukr <- "/Users/marcosechevarria/Documents/University/PhD/Year 2/RA/CHES/West_Experts_Ukraine_checked_Marcos/France_Qualtrics_Ready.xlsx"
#dat <- read_excel(france_ukr, sheet = 1)

#germany_ukr
#germany_ukr <- "/Users/marcosechevarria/Documents/University/PhD/year_2/RA/CHES/West_Experts_Ukraine_checked_Marcos/Germany_Qualtrics_Ready.xlsx"
#dat <- read_excel(germany_ukr, sheet = 1)

#greece_ukr
#greece_ukr <- "/Users/marcosechevarria/Documents/University/PhD/year_2/RA/CHES/West_Experts_Ukraine_checked_Marcos/Greece_Qualtrics_Ready.xlsx"
#dat <- read_excel(greece_ukr, sheet = 1)

#iceland_ukr
#iceland_ukr <- "/Users/marcosechevarria/Documents/University/PhD/year_2/RA/CHES/West_Experts_Ukraine_checked_Marcos/Iceland_Qualtrics_Ready.xlsx"
#dat <- read_excel(iceland_ukr, sheet = 1)

#ireland_ukr
#ireland_ukr <- "/Users/marcosechevarria/Documents/University/PhD/year_2/RA/CHES/West_Experts_Ukraine_checked_Marcos/Ireland_Qualtrics_Ready.xlsx"
#dat <- read_excel(ireland_ukr, sheet = 1)

#italy_ukr
#italy_ukr <- "/Users/marcosechevarria/Documents/University/PhD/year2/RA/CHES/West_Experts_Ukraine_checked_Marcos/italy_ukr.xlsx"
#dat <- read_excel(italy_ukr, sheet = 1)
...
#folder_path <- "/Users/marcosechevarria/Documents/University/PhD/year_2/RA/CHES/West_Experts_Ukraine_checked_Marcos"
#write.xlsx(dat, file = file.path(folder_path, "belgium.xlsx")) #belgium
#write.xlsx(dat, file = file.path(folder_path, "cyprus.xlsx")) #cyprus
#write.xlsx(dat, file = file.path(folder_path, "denmark.xlsx")) #denmark
#write.xlsx(dat, file = file.path(folder_path, "finland.xlsx")) #findland
#write.xlsx(dat, file = file.path(folder_path, "france.xlsx")) #france
#write.xlsx(dat, file = file.path(folder_path, "germany.xlsx")) #germany
#write.xlsx(dat, file = file.path(folder_path, "greece.xlsx")) #greece
#write.xlsx(dat, file = file.path(folder_path, "iceland.xlsx")) #iceland
#write.xlsx(dat, file = file.path(folder_path, "ireland.xlsx")) #ireland
#write.xlsx(dat, file = file.path(folder_path, "italy.xlsx")) #italy
#write.xlsx(dat, file = file.path(folder_path, "austria_ukr.xlsx")) #austria_ukr
#write.xlsx(dat, file = file.path(folder_path, "belgium_ukr.xlsx")) #belgium_ukr
#write.xlsx(dat, file = file.path(folder_path, "denmark_ukr.xlsx")) #denmark_ukr
#write.xlsx(dat, file = file.path(folder_path, "finland_ukr.xlsx")) #finland_ukr
#write.xlsx(dat, file = file.path(folder_path, "france_ukr.xlsx")) #france_ukr
#write.xlsx(dat, file = file.path(folder_path, "germany_ukr.xlsx")) #germany_ukr
#write.xlsx(dat, file = file.path(folder_path, "greece_ukr.xlsx")) #greece_ukr
#write.xlsx(dat, file = file.path(folder_path, "iceland_ukr.xlsx")) #iceland_ukr
#write.xlsx(dat, file = file.path(folder_path, "ireland_ukr.xlsx")) #ireland_ukr
#write.xlsx(dat, file = file.path(folder_path, "italy_ukr.xlsx")) #italy_ukr
